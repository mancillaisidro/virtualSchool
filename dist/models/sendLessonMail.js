...
const createLessonMail = (pname, lessonName, lessonId) => __awaiter(void 0, void 0, void 0, function* () {
...
const deleteLessonMail = (pname, lessonId) => __awaiter(void 0, void 0, void 0, function* () {
    let transporter = nodemailer.createTransport({
        service: "gmail",
        auth: {
            user: process.env.MAILUSER,
...
const updateLessonMail = (pname, data) => __awaiter(void 0, void 0, void 0, function* () {
    let transporter = nodemailer.createTransport({
        service: "gmail",
        auth: {
            user: process.env.MAILUSER,
